    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `cars` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `brand` TEXT NOT NULL, `model` TEXT NOT NULL, `passengers` INTEGER NOT NULL, `size` REAL NOT NULL)');
